...
Ext.ux.NumericField = function(config){
	...
	if(this.useThousandSeparator)
		this.baseChars = this.baseChars + this.thousandSeparator;
...
Ext.extend(Ext.ux.NumericField, Ext.form.NumberField, 
{
    ...
    validateValue : function(v){
    	if(this.useThousandSeparator) {
    		ne = new RegExp('['+this.thousandSeparator+']', 'gi');
    		v = v.replace(ne,'');
    	}
    	return Ext.ux.NumericField.superclass.validateValue.call(this, v);
    },
